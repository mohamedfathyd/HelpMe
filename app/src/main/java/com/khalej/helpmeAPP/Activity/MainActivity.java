...
import com.khalej.helpmeAPP.Adapter.RecyclerAdapter_first;
import com.khalej.helpmeAPP.Adapter.RecyclerAdapter_first_annonce;
...
import com.khalej.helpmeAPP.model.contact_annonce;
import com.khalej.helpmeAPP.model.contact_annonce_realm;
import com.khalej.helpmeAPP.model.contact_home;
import com.khalej.helpmeAPP.model.contact_home_realm;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedpref = getSharedPreferences("Help Me", Context.MODE_PRIVATE);
        edt = sharedpref.edit();
       ...
       myorder=findViewById(R.id.myorder);
        ...
        callus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    String url = "https://api.whatsapp.com/send?phone="+"+9710509233973";
