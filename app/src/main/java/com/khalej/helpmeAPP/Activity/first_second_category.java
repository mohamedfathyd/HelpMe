...
import com.khalej.helpmeAPP.Adapter.RecyclerAdapter;
...
import com.khalej.helpmeAPP.model.contact_second_home;
import com.khalej.helpmeAPP.model.contact_second_home_realm;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_cart: {
                // Do something
                startActivity(new Intent(first_second_category.this,Order_Details.class));
                return true;
            }
        }
